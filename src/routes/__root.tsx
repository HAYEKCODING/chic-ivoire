...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Élégance CI — Mode féminine ivoirienne" },
      {
        name: "description",
        content:
          "Boutique en ligne de mode féminine en Côte d'Ivoire : boubous, bijoux, sacs, chaussures, accessoires et beauté. Paiement à la livraison.",
      },
      { property: "og:title", content: "Élégance CI — Mode féminine ivoirienne" },
      { property: "og:description", content: "Chic Ivoire is a modern French e-commerce website for Ivorian fashion." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { httpEquiv: "Content-Language", content: "fr" },
      { name: "twitter:title", content: "Élégance CI — Mode féminine ivoirienne" },
      { name: "description", content: "Chic Ivoire is a modern French e-commerce website for Ivorian fashion." },
      { name: "twitter:description", content: "Chic Ivoire is a modern French e-commerce website for Ivorian fashion." },
